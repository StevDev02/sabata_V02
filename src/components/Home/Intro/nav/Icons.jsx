function IconCart({ hover }) {
  return ( 
    <>
      <a className="cursor-pointer" href="/ec/shop/">
            <svg
              width="17"
              height="17"
              viewBox="0 0 24 24"
...
function IconUser({ hover }) {
  return (
    <>
          <a href="/ec/auth/login" data-astro-prefetch="tap" className="cursor-pointer">
            <svg
              width="28"
              height="28"
              viewBox="0 0 24 24"
...
export function CartAndUser({ hover }) {
    return (
    <>
      ...
      <div className="bg-white flex items-center gap-1 justify-center rounded-3xl h-[35px] w-[75px]">
        ...
        <div className="flex items-center justify-center bg-black rounded-full w-[33px] h-[33px]  " ><IconCart hover={hover} /></div>
      </div>
      </div>
    </>
  )
