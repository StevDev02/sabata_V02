...
import { c as cn, $ as $$Layout } from './contact_DFuBl9Wi.mjs';
...
import '../index.83dd380a_DeBEShYx.mjs';
...
const ImageComponent = React.forwardRef(
  ({ className, variant, src, alt, width, height, ...props }, ref) => {
    ...
    const [srcSetValue, setSrcSetValue] = useState();
    useEffect(() => {
        ...
        /* @__PURE__ */ jsx(
          ListItem,
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center", children: [
              /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center w-[220px] h-[123px] ", children: /* @__PURE__ */ jsx(ImageComponent, { src: "/public/tacones_nav_intro.webp", width: "200", height: "160", alt: "tacones" }) }),
...
const BackgroundImgComponent = React.forwardRef(
  ({ className, variant, src, ...props }, ref) => {
    const [backgroundImage, setBackgroundImage] = useState(void 0);
    useEffect(() => {
      const isFormatSupported = (format) => {
        const elem = document.createElement("canvas");
        if (!!(elem.getContext && elem.getContext("2d"))) {
...
const $$WomenFashionPage = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BackgroundImgComponent", BackgroundImgComponent, { "src": "/bg-Women_Fashion.webp" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "TextWomenFashion", $$TextWomenFashion, {})} ` })}`;
